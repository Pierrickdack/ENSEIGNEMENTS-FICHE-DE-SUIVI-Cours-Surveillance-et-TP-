            ...
            <form action="./poubelle.php">
                <?php
                    ...
                    try{
                        ...
                        $id=$_SESSION['id'];
                        $request=$connexion -> prepare("SELECT * FROM `corbeille` WHERE ID_corb='$id'");
                        $request -> execute();
                        ...
                        $id=$resultat[0][13];
                        $request=$connexion -> prepare("SELECT code_ue FROM `ue` WHERE ID_ue='$id'");
                        $request -> execute();
